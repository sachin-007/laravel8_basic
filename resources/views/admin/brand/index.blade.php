...
@endif -->
                        ...
                        <form action="{{ route('store.brand') }} " method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="brand_name" type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
                                @error('brand_name')
                            ...
                            <div class="form-group">
                                ...
                                <input name="brand_image" type="file" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
                                @error('brand_image')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
